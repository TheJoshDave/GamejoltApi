...
func _finish_request():
	...
	input = final_string
	var err = $HTTPRequest.request(final_string) #sends the string to the gamejolt gods themselves
...
func _request_completed(result, response_code, headers, body):
	...
	$HTTPRequest.queue_free() #gets rid of the node as it is no longer needed
